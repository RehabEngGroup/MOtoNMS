.. title:: MOtoNMS Reference Documentation
...
.. only:: latex
 ...
 .. toctree::
    ...
    /manual/acknoledgments
    /manual/introduction
    /manual/gettingStarted
    /manual/folders
    /manual/acquisitionInterface
    /manual/C3DtoMAT
    /manual/dataProcessing
    /manual/staticElaboration
    /manual/errorMessages
    /manual/appendixA
    /manual/appendixB
    /manual/appendixC
...
.. only:: html
   ...
   everything without any change in the MATLAB code.

   MOtoNMS also improves the data organization, providing a clear structure
   of input data and automatically generating output directories.
   ...
   + the simtk.org web page: `<https://simtk.org/home/motonms>`_
